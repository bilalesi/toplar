		...
		<View style={styles.container}>
			...
			>
				...
				<Chip
					mode="flat"
					icon="currency-gbp"
					selectedColor={filtersState.maxPcmGbp !== null ? '#6100ee' : undefined}
				...
				<Chip
					mode="flat"
					icon="floor-plan"
					selectedColor={filtersState.minSizeSqm !== null ? '#6100ee' : undefined}
				...
				<Chip
					mode="flat"
					icon="hotel"
					selectedColor={filtersState.minNumRooms !== null ? '#6100ee' : undefined}
