	...
	return (
		<View style={styles.container}>
			...
			<LinearGradient
				...
				colors={['rgba(97,0,238,0)', 'rgba(97,0,238,0.4)', 'rgba(97,0,238,0.8)']}
				locations={[0, 0.8, 1]}
			>
				...
				<View style={styles.content}>
					...
					/>
					<Title style={styles.title}>TOPLAR</Title>
					<Separator />
					<Headline style={{ color: '#FFFFFF', textAlign: 'center' }}>
						Find over a million properties to rent from the top 3% of estate agents and
						developers.
					</Headline>
				</View>
				<View style={styles.space} />
